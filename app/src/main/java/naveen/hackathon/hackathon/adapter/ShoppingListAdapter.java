...
import naveen.hackathon.hackathon.customview.ItemTouchHelperViewHolder;
import naveen.hackathon.hackathon.customview.OnStartDragListener;
...
import naveen.hackathon.hackathon.fragment.MyCartFragment;
...
public class ShoppingListAdapter extends
        RecyclerView.Adapter<ShoppingListAdapter.ItemViewHolder> implements
         naveen.hackathon.hackathon.customview.ItemTouchHelperAdapter {
    ...
    public void onBindViewHolder(final ItemViewHolder holder, final int position) {
        ...
        Glide.with(context).load(ImageUrl).apply(new RequestOptions().placeholder(drawable)
                .error(drawable).centerCrop()).into(holder.imagView);
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder
        ...
        public ItemViewHolder(View itemView) {
            ...
            itemDesc = (TextView) itemView.findViewById(R.id.item_short_desc1);
