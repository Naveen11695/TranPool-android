...
package naveen.hackathon.hackathon.util;
...
public class Utils {
    ...
    public static final String ATTRIBUTE_SCHEMA = "http://schemas.android.com/apk/lib/naveen.hackathon.hackathon.util";
...
//	}
    ...
    public static void switchContent(int id, String TAG,
        ...
        if (CURRENT_TAG == null || !TAG.equals(CURRENT_TAG)) {
            ...
            // one
            if (fragment == null) {
                 if (TAG.equals(SHOPPING_LIST_TAG)) {
